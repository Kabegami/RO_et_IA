...
class Agent(object):
    ...
    def step(self):
        ...
        self.params = [5.283379741767149, -8.618391602478413, -5.575340949516648, 4.903281189028352, 6.39748364476295, -5.423687053573678, -11.248308901412317, -7.400632226769154, 1.831376158546453, 3.2825297984039836, 4.139807447888542, -5.531333152456136, -14.765804180022247, -8.000568561911056, 1.0161963311609223, -2.997484343095283, -2.321062239505882, 7.4760676296119]
        self.stepController()
