...
class Agent(object):
    ...
    id = -1
    robot = -1
    name = "Equipe Raoul" # A modifier avec le nom de votre équipe
    ...
    def step(self):
        ...
        #love_obstacle(p,sensors,maxSensorDistance,maxRotationSpeed)
        #hate_obstacle(p,sensors,maxSensorDistance,maxRotationSpeed)
        love_players(p,sensors,maxSensorDistance,maxRotationSpeed)
